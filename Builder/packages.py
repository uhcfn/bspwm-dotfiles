...
BASE_PACKAGES = [
    ...
    "fish", "gcc", "gedit", "git", "gnu-netcat", "htop", "btop", "nano", "lxappearance",
    "mpv", "thunar", "neofetch", "network-manager-applet", "nitrogen",
    "pamixer", "papirus-icon-theme", "pavucontrol", "polybar", "autoconf", "pulseaudio",
    "pulseaudio-alsa", "python-pyalsa", "ranger", "redshift", "reflector", "rofi", "rofi-calc", "calcurse",
    "rofi-emoji", "scrot", "sudo", "slop", "tree", "unrar", "zip", "unzip", "xarchiver",
